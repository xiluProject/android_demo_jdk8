...
public class NativeSelfRenderListActivity extends AppCompatActivity implements OnRefreshLoadMoreListener {
...
//                .nativeStyle(adNativeStyle)
        ...
        nativeAd.setListener(new ADXiluNativeAdListener() {
            ...
            public void onRenderFailed(ADXiluNativeAdInfo adInfo, ADXiluError error) {
                ...
                // 广告渲染失败，释放和移除ADXiluNativeAdInfo
    ...
    private void loadData() {
        ...
        nativeAd.loadAd(ADXiluDemoConstant.NATIVE_AD_POS_ID4, ADXiluDemoConstant.NATIVE_AD_COUNT);
    }
